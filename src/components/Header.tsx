      ...
      {menuOpen && (
        <>
          ...
          <div className="fixed top-0 right-0 h-full w-full max-w-md bg-white shadow-2xl z-50 overflow-y-auto animate-slide-in">
            <div className="sticky top-0 bg-blue-50/50 p-6 flex items-center justify-between border-b border-gray-100">
                <button
                onClick={() => {
                  onHome();
                  setMenuOpen(false);
            ...
            <div className="p-6">
              ...
              {onAllTeams && (
                ...
                >
                  ...
                  <span className="font-normal text-gray-600"><a href="/all-teams">Latest rankings</a></span>
                </button>
              )}
