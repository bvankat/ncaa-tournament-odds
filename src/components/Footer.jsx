...
export function Footer({ onHome, teams = [], selectedSlug = '', onTeamSelect }) {
  return (
    <footer className="bg-black text-white">
      <div className="max-w-6xl mx-auto px-8 py-12 grid grid-cols-1 md:grid-cols-3 gap-12">
        ...
        <div>
          <h3 className="text-xs uppercase geist-mono tracking-wider text-gray-400 mb-4">
            Select a team
          </h3>
          <Combobox
            teams={teams}
            value={selectedSlug}
            onValueChange={(val) => onTeamSelect && onTeamSelect(val)}
